...
export class NichosService {
 private apiUrl = 'http://localhost:3000/api/nichos';
  ...
  private sectores: { [key: string]: Nicho[] } = {
    A: [
      { id: 'A1', cedulaPropietario: '1234567890', nombrePropietario: 'Juan Pérez', sector: '1', numero: '1', estado: 'disponible' },
      { id: 'A2', cedulaPropietario: '87654321', nombrePropietario: 'María López', sector: '1', numero: '2', estado: 'ocupado' },
      { id: 'A3', cedulaPropietario: '11223344', nombrePropietario: 'Carlos Ramírez', sector: '1', numero: '3', estado: 'reservado' },
      { id: 'A4', cedulaPropietario: '44332211', nombrePropietario: 'Ana Gómez', sector: '1', numero: '4', estado: 'reservado' },
      { id: 'A5', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '5', estado: 'disponible' },
      { id: 'A6', cedulaPropietario: '55667788', nombrePropietario: 'Luis Martínez', sector: '1', numero: '6', estado: 'ocupado' },
      { id: 'A7', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '7', estado: 'disponible' },
      { id: 'A8', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '8', estado: 'reservado' },
      { id: 'A9', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '9', estado: 'reservado' },
      { id: 'A10', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '10', estado: 'disponible' },
      { id: 'A11', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '11', estado: 'ocupado' },
      { id: 'A12', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '12', estado: 'disponible' },
      { id: 'A13', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '13', estado: 'reservado' },
      { id: 'A14', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '14', estado: 'reservado' },
      { id: 'A15', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '15', estado: 'disponible' },
      { id: 'A16', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '16', estado: 'ocupado' },
      { id: 'A17', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '17', estado: 'disponible' },
      { id: 'A18', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '18', estado: 'reservado' },
      { id: 'A19', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '19', estado: 'reservado' },
      { id: 'A20', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '20', estado: 'disponible' },
      { id: 'A21', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '21', estado: 'ocupado' },
      { id: 'A22', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '22', estado: 'disponible' },
      { id: 'A23', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '23', estado: 'reservado' },
      { id: 'A24', cedulaPropietario: '', nombrePropietario: '', sector: '1', numero: '24', estado: 'reservado' }
    ],
    B: [
      { id: 'B1', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '1', estado: 'disponible' },
      { id: 'B2', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '2', estado: 'ocupado' },
      { id: 'B3', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '3', estado: 'reservado' },
      { id: 'B4', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '4', estado: 'reservado' },
      { id: 'B5', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '5', estado: 'disponible' },
      { id: 'B6', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '6', estado: 'ocupado' },
      { id: 'B7', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '7', estado: 'disponible' },
      { id: 'B8', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '8', estado: 'reservado' },
      { id: 'B9', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '9', estado: 'reservado' },
      { id: 'B10', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '10', estado: 'disponible' },
      { id: 'B11', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '11', estado: 'ocupado' },
      { id: 'B12', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '12', estado: 'disponible' },
      { id: 'B13', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '13', estado: 'reservado' },
      { id: 'B14', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '14', estado: 'reservado' },
      { id: 'B15', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '15', estado: 'disponible' },
      { id: 'B16', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '16', estado: 'ocupado' },
      { id: 'B17', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '17', estado: 'disponible' },
      { id: 'B18', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '18', estado: 'reservado' },
      { id: 'B19', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '19', estado: 'reservado' },
      { id: 'B20', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '20', estado: 'disponible' },
      { id: 'B21', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '21', estado: 'ocupado' },
      { id: 'B22', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '22', estado: 'disponible' },
      { id: 'B23', cedulaPropietario: '', nombrePropietario: '', sector: '2', numero: '23', estado: 'reservado' },
      { id: 'B24', cedulaPropietario: '1316623030', nombrePropietario: 'Hansel Alcívar', sector: '2', numero: '24', estado: 'reservado' }
    ],
    C: [
