...
import {
  ...
  Solicitud,
  DocumentoSolicitud,
} from '../../../features/tramites/models/tramite.model';
...
export class TramiteService {
  ...
  getDocumentosTipo(id_tipo: number): Observable<DocumentoTipo[]> {
    return this.http.get<DocumentoTipo[]>(
      `${this.apiUrl}/tipos/${id_tipo}/documentos`,
    );
  }
  ...
  getSolicitudes(id_tipo_tramite?: number): Observable<Solicitud[]> {
    ...
    if (id_tipo_tramite)
      params = params.set('id_tipo_tramite', id_tipo_tramite);
  ...
  getDocumentos(id_solicitud: number): Observable<DocumentoSolicitud[]> {
    return this.http.get<DocumentoSolicitud[]>(
  ...
  subirDocumentoRespuesta(
    ...
    return this.http.post<any>(
      `${this.apiUrl}/${id_solicitud}/documento-respuesta`,
      formData,
    );
  }
  getMisSolicitudes(
    ...
    if (id_tipo_tramite)
      params = params.set('id_tipo_tramite', id_tipo_tramite.toString());
  ...
  getUrlRespuesta(id_solicitud: number): Observable<{ url: string }> {
    return this.http.get<{ url: string }>(
      `${this.apiUrl}/${id_solicitud}/respuesta-url`,
    );
  }
  ...
  getPendientesCountByTipo(): Observable<
    { id_tipo_tramite: number; pendientes: number }[]
  > {
    return this.http.get<{ id_tipo_tramite: number; pendientes: number }[]>(
      `${this.apiUrl}/pendientes/count-by-tipo`,
    );
  }
}
